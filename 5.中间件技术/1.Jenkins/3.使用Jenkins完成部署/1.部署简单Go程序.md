...
![image-20231129132150988](image/image-20231129132150988.png)

输入任务名，选择第一项，点击确定

![image-20231129132302309](image/image-20231129132302309.png)

![image-20231129133406561](image/image-20231129133406561.png)

在这个地方选择使用Git，输入Git的URL，添加凭证，并指定分支。

![image-20231129133551595](image/image-20231129133551595.png)

新建凭证，主要输入的就是用户名、密码（Gitee平台的）、描述，这个ID项不用填，Jenkins会自动生成。

如果这里不小心多建了几个凭证，可以在下面这个页面进行删除

![image-20240116154215950](image/image-20240116154215950.png)

![image-20240116154302528](image/image-20240116154302528.png)

![image-20240116154311602](image/image-20240116154311602.png)

往下翻，在增加构建步骤里选择“执行shell”

![image-20231129133945824](image/image-20231129133945824.png)
...
![image-20231129190210102](image/image-20231129190210102.png)

点击保存，然后点击“立即构建”

![image-20231129134201650](image/image-20231129134201650.png)

我们发现构建失败了

![image-20231129134339644](image/image-20231129134339644.png)

点击“控制台输出”，看看报错信息

![image-20231129134401255](image/image-20231129134401255.png)
...
![image-20231129134843215](image/image-20231129134843215.png)
...
![image-20231129135108526](image/image-20231129135108526.png)
...
![image-20231129143836769](image/image-20231129143836769.png)

![image-20231129143849810](image/image-20231129143849810.png)
...
![image-20231129152003522](image/image-20231129152003522.png)

然后重新点击构建，查看控制台输出

![image-20231129190904795](image/image-20231129190904795.png)
