...
在`Mac`中，我们可以使用`Command + Space`快捷键，打开聚焦搜索后，搜索“钥匙串访问`APP`”：

<img src="image/image-20251224100249370.png" alt="image-20251224100249370" style="zoom:40%;" />

在这个`APP`中我们可以看到本机的`GitHub`凭证，在这里也可以修改其用户名、密码，或者删除该凭证：

<img src="image/image-20251224100122011.png" alt="image-20251224100122011" style="zoom:40%;" />

更推荐的做法是配置`SSH`密钥进行凭证管理，以避免因令牌过期或权限变更而需要频繁重新生成令牌的问题。
