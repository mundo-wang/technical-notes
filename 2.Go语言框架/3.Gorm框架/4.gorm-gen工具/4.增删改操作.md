...
<img src="image/image-20240619164847101.png" alt="image-20240619164847101" style="zoom:120%;" />
...
<img src="image/image-20240625090422775.png" alt="image-20240625090422775" style="zoom:110%;" />
...
在使用`gorm-gen`生成代码时传入的`db`对象，主要是为了指定生成与哪个数据库对应的表。这里需要再次传入`db`对象，目的是指定后续的增删改查操作将在哪个数据库上执行。
