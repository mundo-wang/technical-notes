...
> 在`2025.2`版本的`Goland`中，该项默认就是关闭的。
...
> 在`2025.2`版本的`Goland`中，该项的名称变为`ide.await.project.scope.completion`，默认就是关闭的。

### 14. 调整引用计数提示位置

在代码中，`GoLand`会为每个函数或全局变量维护一个引用计数，用于展示其被调用或被使用的次数：

<img src="image/image-20251214183504233.png" alt="image-20251214183504233" style="zoom:40%;" />

我们可能会发现这个引用计数在全局变量或者函数的上方，有些影响美观：

<img src="image/image-20251214183643367.png" alt="image-20251214183643367" style="zoom:40%;" />

我们打开`Settings`，按下面的步骤进行调整：

<img src="image/image-20251214183905706.png" alt="image-20251214183905706" style="zoom:30%;" />

调整后，引用计数的显示如下所示，看起来美观一些：

<img src="image/image-20251214183954515.png" alt="image-20251214183954515" style="zoom:40%;" />
