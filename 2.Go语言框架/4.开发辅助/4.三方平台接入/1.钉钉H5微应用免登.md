...
ADD COLUMN `app_icon` VARCHAR(128) NOT NULL DEFAULT '' COMMENT '钉钉应用图标地址' AFTER `home_page_url`,
ADD COLUMN `status` TINYINT NOT NULL DEFAULT 0 COMMENT '应用授权状态：0=未授权，1=已授权' AFTER `app_icon`;
```
