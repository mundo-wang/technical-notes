...
![image-20250901151046929](image/image-20250901151046929.png)
...
后端 --> 前端 : 返回系统token与accessToken
前端 -> 企微服务 : 调用code2session接口，传递accessToken、code
企微服务 --> 前端: 返回corpid、userid、session_key，完成登录流程
@enduml
```
