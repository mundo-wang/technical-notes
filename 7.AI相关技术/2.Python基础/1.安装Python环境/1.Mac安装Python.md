...
```sh
python3 --version # python3 -V 亦可
pip3 --version    # pip3 -V 亦可
```
...
```sh
python --version # python -V 亦可
pip --version    # pip -V 亦可
```

查看到的内容如下所示：

<img src="image/image-20260429102310110.png" alt="image-20260429102310110" style="zoom:40%;" />
